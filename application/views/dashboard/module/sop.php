	...
	<div class="" style="width:100%;min-height:auto;margin-bottom: 40px">
		<div class="row">
			...
			<form action="<?php echo base_url('dashboard/Qhse/sop') ?>" method="GET" id="form_search">
	...
	<h6>Search Result</h6>
			...
			?>
				<tr>
					...
					<td id="attch"><input type="button" class="btn btn-success" value="<?php echo $result['lampiran']?> / Download Here" class="btn" onclick="location.href='<?php echo base_url('assets/sop/'.$result['lampiran'])?>' "></td>
				</tr>
			<?php } ?>
			</tbody>
		</table>
